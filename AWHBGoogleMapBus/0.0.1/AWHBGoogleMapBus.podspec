#
#  Be sure to run `pod spec lint AWHBGoogleMapBus.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBGoogleMapBus.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "AWHBGoogleMapBus"
  s.version      = "0.0.1"
  s.summary      = "A short description of AWHBGoogleMapBus."
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHBGoogleMapBus"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHBGoogleMapBus.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHBGoogleMapBus/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHBGoogleMapBus/**/*.h"

  s.vendored_frameworks = ['AWHBGoogleMapBus.framework']
  s.source_files = 'AWHBGoogleMapBus.framework/Headers/*h'
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHBGoogleMapBusLocalizable.bundle']

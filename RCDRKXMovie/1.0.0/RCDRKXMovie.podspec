#
#  Be sure to run `pod spec lint RCDRKXMovie.podspec' to ensure this is a
#  确保运行“pod spec lint RCDRKXMovie.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "RCDRKXMovie"
  s.version      = "1.0.0"
  s.summary      = "A short description of RCDRKXMovie."
  ...
  s.homepage     = "https://github.com/zhangwen31/RCDRKXMovie"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/RCDRKXMovie.git", :tag => "#{s.version}" }
...
#  s.source_files  = "RCDRKXMovie/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "RCDRKXMovie/**/*.h"
  
  s.vendored_frameworks = ['RCDRKXMovie.framework']
  s.source_files = 'RCDRKXMovie.framework/Headers/*h'
  ...
  # s.resource  = "icon.png"
  s.resources = ['RCDRKXMovie.framework/RCDRKXMovie.bundle']

#
#  Be sure to run `pod spec lint AWHSettingConfig.podspec' to ensure this is a
#  确保运行“pod spec lint AWHSettingConfig.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "AWHSettingConfig"
  s.version      = "1.0.2"
  s.summary      = "A short description of AWHSettingConfig."
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHSettingConfig"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHSettingConfig.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHSettingConfig/**/*.{h,m,swift}"
...
#  s.public_header_files = "AWHSettingConfig/**/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHSettingConfigLocalizable.bundle']

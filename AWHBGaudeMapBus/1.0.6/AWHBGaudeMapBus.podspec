#
#  Be sure to run `pod spec lint AWHBGaudeMapBus.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBGaudeMapBus.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHBGaudeMapBus"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHBGaudeMapBus.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHBGaudeMapBus/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHBGaudeMapBus/**/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHBGaudeMapBusLocalizable.bundle']

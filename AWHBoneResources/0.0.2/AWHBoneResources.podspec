...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHBoneResources"
  ...
  s.social_media_url   = "https://github.com/zhangwen31/AWHBoneResources.git"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHBoneResources.git", :tag => "#{s.version}" }

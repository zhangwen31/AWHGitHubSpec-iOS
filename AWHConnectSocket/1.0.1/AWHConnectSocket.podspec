#
#  Be sure to run `pod spec lint AWHConnectSocket.podspec' to ensure this is a
#  确保运行“pod spec lint AWHConnectSocket.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "AWHConnectSocket"
  s.version      = "1.0.1"
  s.summary      = "A short description of AWHConnectSocket."
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHConnectSocket"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHConnectSocket.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHConnectSocket/**/*.{h,m,swift,c}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHConnectSocket/**/*.h"

  s.vendored_frameworks = ['AWHConnectSocket.framework']
  ...
  s.source_files = 'AWHConnectSocket.framework/Headers/*h'
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHConnectSocketLocalizable.bundle']

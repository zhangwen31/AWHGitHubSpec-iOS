#
#  Be sure to run `pod spec lint AWHBPublicBusiness.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBPublicBusiness.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHBPublicBusiness"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHBPublicBusiness.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHBPublicBusiness/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHBPublicBusiness/**/*.h"
  
  s.vendored_frameworks = ['AWHBPublicBusiness.framework']
  s.source_files = 'AWHBPublicBusiness.framework/Headers/*h'

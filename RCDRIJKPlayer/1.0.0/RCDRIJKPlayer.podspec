#
#  Be sure to run `pod spec lint RCDRIJKPlayer.podspec' to ensure this is a
#  确保运行“pod spec lint RCDRIJKPlayer.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "RCDRIJKPlayer"
  s.version      = "1.0.0"
  s.summary      = "A short description of RCDRIJKPlayer."
  ...
  s.homepage     = "https://github.com/zhangwen31/RCDRIJKPlayer.git"
  ...
  # s.authors            = { "王恒" => "1066026709@qq.com" }
   s.social_media_url   = "https://github.com/zhangwen31/RCDRIJKPlayer"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/RCDRIJKPlayer.git", :tag => "#{s.version}" }
  ...
  #s.source_files  = "RCDRIJKPlayer/**/*.{h,m,swift,framework}"
  ## s.exclude_files = "Classes/Exclude"   #排除文件

  #s.public_header_files = "RCDRIJKPlayer/**/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/RCDRIJKPlayerLocalizable.bundle']
